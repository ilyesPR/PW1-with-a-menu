...
PlaySound("nav-sound2.wav",NULL,SND_SYNC | SND_LOOP | SND_FILENAME);
while (3) {
printf("\n\n\n\n\t\t\t\tWould you like to listen to some lobby music while at it?");
printf(w g_h"\n\n\n\n\n\n\n\n\t\t\t\t\t\t Yes (y) ");
printf(w r_h"\t No (n) ");
printf(clr"");
musicMenu = getch();
if (musicMenu == 'y') goto yesMusic;
else if (musicMenu == 'n') break;
system("cls");
}

Musika:;
if (musicMenu == 'y') { yesMusic: PlaySound("DOORS.wav",NULL,SND_ASYNC | SND_LOOP | SND_FILENAME); }


while (4) {
exoMenu: ;
if (musicMenu=='n') PlaySound("C:nav-sound2.wav",NULL,SND_SYNC | SND_LOOP | SND_FILENAME);
exoChoice = "";
printf(clr"");
system("cls");
printf(w bold"\n\n\n\n\n\n\t\t\t\t\t\t    Choose an exercise!\n"clr);
...
PlaySound("bang.wav",NULL,SND_SYNC | SND_LOOP | SND_FILENAME);
Sleep(1000);
...
PlaySound("C:/Users/Djihad/Documents/C/sound_board/bang.wav",NULL,SND_SYNC | SND_LOOP | SND_FILENAME);
Sleep(2000);
printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\t\t\t\t\tPress any key to move back to the exercise menu");
getch();
goto Musika;
